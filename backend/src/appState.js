...
export function buildScannerHealth(markets, cfg = {}) {
  const health = {
    ...
    min_volume: Number(cfg.scanner_min_volume || 200),
    min_liquidity: Number(cfg.scanner_min_liquidity || 200),
    max_days: Number(cfg.scanner_max_days || 30),
    min_anomaly_score: Number(cfg.scanner_min_anomaly_score || 5),
    active_from_utc: Number(cfg.scanner_active_from_utc || 6),
    active_to_utc: Number(cfg.scanner_active_to_utc || 23),
    ws_enabled: Boolean(cfg.scanner_ws_enabled),
    ws_auto_reconnect: Boolean(cfg.scanner_ws_auto_reconnect),
    max_slippage_pct: Number(cfg.scanner_max_slippage_pct || 0.02)
  };
